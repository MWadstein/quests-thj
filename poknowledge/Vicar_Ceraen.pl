...
sub EVENT_ITEM {
  ...
  if ($turnedin < $maxturnedin) {
    while(quest::handin({ 29112 => 1 })) { # Item(s): Ethereal Parchment
      quest::summonitem(quest::ChooseRandom(59578, 28556, 28646, 28557, 28561, 28572, 21690, 26945, 26946, 28558, 28563, 28566, 28567, 28564, 26947)); #Level 61 or 62 Cleric spell, PoP (Faith, Symbol of Kazad, Ward of Gallantry, Tarnation, Sermon of Penitence, Petrifying Earth, Greater Immobilize, Virtue, Blessing of Reverence, Supernal Elixir, Condemnation, Catastrophe, Pacification)
      $turnedin++;
  ...
  if ($turnedin < $maxturnedin) {
    while(quest::handin({ 29131 => 1 })) { # Item(s): Spectral Parchment
      quest::summonitem(quest::ChooseRandom(59579, 21647, 28569, 28571, 28573, 28559, 28560, 28562)); #Level 63 or 64 Cleric spell, PoP (Kazad's Mark, Hammer of Damnation, Supernal Light, Sound of Might, Destroy Undead, Mark of Kings, Word of Replenishment)
      $turnedin++;
