...
sub EVENT_ITEM {
  ...
  if ($turnedin < $maxturnedin) {
    while(quest::handin({ 29112 => 1 })) { # Item(s): Ethereal Parchment
      quest::summonitem(quest::ChooseRandom(28439, 26944, 28413, 28438, 28437, 21662, 28440, 28441, 28442)); #Level 61 or 62 Wizard spell, PoP (Greater Fetter, Shield of the Arcane, Tears of Ro, Resistant Armor, Teleport, Elemental Barrier, Draught of Ro, or Lure of Ro)
      $turnedin++;
  ...
  if ($turnedin < $maxturnedin) {
    while(quest::handin({ 29131 => 1 })) { # Item(s): Spectral Parchment
      quest::summonitem(quest::ChooseRandom(59627, 59629, 59528, 59624, 28414, 28445, 28446, 28448, 26940, 28415, 28444, 28447)); #Level 63 or 64 Wizard spell, PoP (Force Shield, Draught of Thunder, Agnarr's Thunder, Iceflame of E'ci, Tears of Arlyxir, Shield of Maelin, Telekin, or Draught of E'ci)
      $turnedin++;
  ...
  if($turnedin >= 1) {
    quest::emote("almost brashly snatches the item out of your grip with his small, cold froglok hands. The wizard eyes the item quickly, nodding and mumbling to himself at an inaudible tone. Eventually, the wizard begins to weave a spell around the item, which seems to become saturated with the conjured magic. Runes of a brilliant, shimmering azure appear upon the parchment, which is now wholly tangible in its form. As the spell ends, the forglok inspects his work one last time before offering the spell to you.");
    quest::say("Take this, $name. Do not use it without caution or discipline, for the power is unlike anything you have wielded in the past. It will affect both the divine and primal realms, despite its astral birth.");
  }
}
